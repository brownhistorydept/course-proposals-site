...
export const GEO_REGIONS = Object.freeze([
  "Africa",
  "East Asia",
  "Europe",
  "Latin America",
...
export const PROPOSAL_STATUS = Object.freeze({
  ...
  // undergraduate or graduate director rejects
  DIRECTOR_CCC_REJECTED: "revisions requested by director and manager",
...
const courseSchema = new Schema<ICourse>({
  ...
  is_SOPH: { type: Boolean, required: false },
  ...
  manager_comments: { type: String, required: false },
