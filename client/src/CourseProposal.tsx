...
function CourseProposal() {
  ...
  function wordCounter(curText: string) {
    var wordList = curText.match(/[^\s]+/g);
    if (wordList !== null) {
  ...
  async function hasError() {
    if (courseTitle === "") {
      ...
      openAlert(
        "You have indicated that you are not a regular professor. In that case, please indicate your role."
      );
      return true;
    } else if (wordCounter(transcriptTitle) > 30) {
      openAlert("Transcript title must be 30 words or less.");
      return true;
    } else if (wordCounter(description) > 140) {
      openAlert("Course description must be 140 words or less.");
      return true;
    }
    ...
    <div className="CourseProposal">
      ...
      <Grid container spacing={2} maxWidth={1000} mx="auto">
          ...
          <Grid item xs={11} container spacing={2}>
            ...
            <Grid item xs={8}>
              ...
              <FormHelperText sx={{ fontSize: "14px" }}>
                Full course number, including dept. abbreviation (e.g.
                HIST0150A), entered by manager.
              </FormHelperText>
            </Grid>
          </Grid>
        )}
          ...
          <Grid item xs={11} container spacing={2}>
            ...
            <Grid marginLeft={1.8} marginTop={2}>
              <FormControl style={{ minWidth: 120 }}>
                ...
                >
                  <MenuItem aria-label="None" value="Other">
                    Other
                  </MenuItem>
              ...
              <FormHelperText sx={{ fontSize: "14px" }}>
                Time slot for the course, entered by manager.
              </FormHelperText>
            </Grid>
        ...
        <Grid item xs={9.5}>
          ...
          <FormHelperText sx={{ fontSize: "14px" }}>
            Are you a regular tenure-track/tenured history department faculty
            member?
          </FormHelperText>
        </Grid>
        ...
        <Grid item xs={10}>
          <TextField
            ...
            fullWidth
            required
            helperText={wordCounter(transcriptTitle) + "/30 words"}
            ...
            >
              ...
              {allProfessors?.map((prof, index) => (
                <MenuItem key={index} value={prof.displayName}>
                  <Checkbox
                    checked={professors.indexOf(prof.displayName) > -1}
                  />
                  <ListItemText
                    primary={`${prof.displayName} (${prof.email})`}
                  />
                </MenuItem>
              ))}
            </Select>
        ...
        <Grid item xs={10}>
          ...
          <FormHelperText sx={{ fontSize: "14px" }}>
            The geographic region that best fits the content of the course (only
            required for undergraduate courses).
          </FormHelperText>
        </Grid>
        ...
        <Grid item xs={3.33}>
          ...
          <FormHelperText sx={{ fontSize: "14px" }}>
            Your preference ranking for course time slots, which will inform the
            final time choice.
          </FormHelperText>
        </Grid>
        <Grid item xs={3.33}>
        ...
        <Grid item xs={3.33}>
          ...
          <FormHelperText sx={{ fontSize: "14px" }}>
            Any course time slots during which you are unavailable to teach
            (select all that apply).
          </FormHelperText>
        </Grid>
        ...
        <Grid item xs={10}>
          <TextField
            fullWidth
            value={description}
            helperText={wordCounter(description) + "/140 words"}
            multiline={true}
            rows={5}
            onChange={(e) => setDescription(e.target.value)}
          />
          <FormHelperText sx={{ fontSize: "14px" }}>
            A short paragraph describing the course content, which will end up
            on CAB.
          </FormHelperText>
        </Grid>
        ...
        <Grid item xs={3}>
          <FormGroup>
            <Tooltip
              title="Subject to CCC approval in accordance with their guidelines - syllabus submission required"
              placement="left"
            >
              <FormControlLabel
                control={
                  <Checkbox
                    checked={writ}
                    onClick={(e) => {
                      setWrit((e.target as HTMLInputElement).checked);
                    }}
                  />
                }
                label="WRIT"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={rpp}
                    onClick={(e) => {
                      setRPP((e.target as HTMLInputElement).checked);
                    }}
                  />
                }
                label="RPP"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={premodern}
                    onClick={(e) => {
                      setPremodern((e.target as HTMLInputElement).checked);
                    }}
                  />
                }
                label="Premodern"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={fys}
                    onClick={(e) => {
                      setFYS((e.target as HTMLInputElement).checked);
                    }}
                  />
                }
                label="FYS"
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={soph}
                    onClick={(e) => {
                      setSoph((e.target as HTMLInputElement).checked);
                    }}
                  />
                }
                label="SOPH"
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={coex}
                  onClick={(e) => {
                    setCOEX((e.target as HTMLInputElement).checked);
                  }}
                />
              }
              label="COEX"
        ...
        <Grid item xs={3}>
          <FormGroup>
            <FormControlLabel
              control={
                <Checkbox
                  checked={remoteOnly}
                  onClick={(e) => {
                    setRemoteOnly((e.target as HTMLInputElement).checked);
                  }}
                />
              }
              label="Remote Only"
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={remoteAccessible}
                  onClick={(e) => {
                    setRemoteAccessible((e.target as HTMLInputElement).checked);
                  }}
                />
              }
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={cblr}
                  onClick={(e) => {
                    setCBLR((e.target as HTMLInputElement).checked);
                  }}
                />
              }
              label="CBLR"
        ...
        <Grid item xs={10}>
          ...
          />
          <FormHelperText sx={{ fontSize: "14px" }}>
            Any extra notes you would like to add that do not fit into the other
            fields.
          </FormHelperText>
        </Grid>
        ...
        <Grid item xs={10}>
          ...
          />
          <FormHelperText sx={{ fontSize: "14px" }}>
            Please remember that if you are a regular professor teaching for the
            second time, you must add a link to your syllabus. You may also
            email a copy of your syllabus to the Student Affairs Manager.
          </FormHelperText>
        </Grid>
