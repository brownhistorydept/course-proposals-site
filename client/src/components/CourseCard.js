      ...
      <Grid container spacing={3}>
            ...
            <Grid item xs container>
              <Grid item xs container>
                <FormGroup row>
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox disabled checked={course.is_premodern} />
                    }
                    label="Premodern"
                  />
                  <FormControlLabel
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox disabled checked={course.is_remote_only} />
                    }
                    label="Remote Only"
                  />
                  <FormControlLabel
                    control={
                      <Checkbox
                        disabled
                        checked={course.is_remote_accessible}
                      />
                    }
        ...
        <Grid item align="center" justify="center" my="auto" mr={2}>
          <Link
            ...
            to={"/view_course?" + selectedSems}
            state={{
              course: course,
              canEdit: canEdit,
              canAccept: canAccept,
              canNewProposal: canNewProposal,
              isRestrictedView: isRestrictedView,
            }}
          >
            <Button
              variant="contained"
              sx={{ textTransform: "none", backgroundColor: "#992525" }}
            >
              <Typography gutterBottom variant="body1">
                View Course
              </Typography>
